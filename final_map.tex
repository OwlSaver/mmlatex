...
\begin{tikzpicture}[
  ...
  \node[concept] { \textbf{Project\\ Phases} }    child[grow=150] {
        node[concept] {Planning}        child {
            node[concept] {Scope Definition}        } 
        child {
            node[concept] {Resource Allocation}    } } 
    child[grow=30] {
        node[concept] {Execution}        child {
            node[concept] {Development}        } 
        child {
            node[concept] {Testing}    } } 
    child[grow=270] {
        node[concept] {Closure}        child {
            node[concept] {Review}        } 
        child {
            node[concept] {Sign-off}} } 
...
\begin{longtable}{@{} p{0.3\textwidth} p{0.6\textwidth} @{}}
    ...
    Planning & ghgg \\
    \midrule
    Scope Definition & gsfgfg fggfgf g fgfsg dfggfdgf fg \\
    \midrule
    Resource Allocation & ghd sg g dg g sdgsgf \\
    \midrule
    Execution &  \\
    \midrule
    Development &  \\
